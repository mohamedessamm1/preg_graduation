...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => HomeCubit()..fetchMyData(),
                        ...
                        if(HomeCubit.get(context).foundItem?['title']==null)...{
                          ...
                          GridView(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => HealthTrackerScreen(),));
                                  },
                                  child: ItemGridWidget(
                                    title: 'health',
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => VacattionScreen(),));
                                  },
                                  child: ItemGridWidget(
                                    title: 'Vacattion',
